...
- gdc-values.yaml - typically override defaults in deploy scripts
- gdc-pv-*.yaml - definition of persistent volumes (local-storage)

Deploy scripts
--------------
- ii and perf
- deploys 2x 4-node Minio clusters
- execute manually command by command
- there are options - e.g. to setup federation

Destroy scripts
---------------

- destroy related deployment
